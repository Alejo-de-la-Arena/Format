...
rows[1].intro_text = 'THE ENERGY RISES.';
rows[1].intro_motion = 'ascend';
...
mock.listen(4321, '127.0.0.1', () => {
  const server = spawn(process.execPath, ['node_modules/next/dist/bin/next', 'dev', '--hostname', '127.0.0.1', '--port', '4320'], {
    stdio: 'inherit', windowsHide: true,
    env: { ...process.env, FORMAT_QA_DIST: '.next-polish-qa-intro', NEXT_PUBLIC_SUPABASE_URL: 'http://127.0.0.1:4321', NEXT_PUBLIC_SUPABASE_ANON_KEY: 'local-fixture-only' },
  });
