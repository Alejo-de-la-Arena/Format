...
import { getLabClipCover, isVideoUrl } from "@/lib/embed";
                ...
                >
                  ...
                  <div className="max-lg:-mx-[calc(clamp(18px,4vw,48px)+12px)]">
                    <VideoPlayer
                      ...
                      accent={colors[0]}
                      aspect="16 / 9"
                      posterSrc={getLabClipCover(clip.url)}
...
export default async function SeasonPage({
  ...
  return (
    <div className="relative min-h-screen" style={seasonAccentVars(season)}>
      <Nav season={season} showBackButton={false} />
      <main className="relative isolate">
        <Grainient
          ...
          grainAmount={0.035}
          noiseScale={1.6}
          className="pointer-events-none z-0 opacity-[0.09] mix-blend-multiply"
        />
